...
## RUNTIME VARIABLES ##
########################
ENVIRONMENT = os.environ.get('ENVIRONMENT','dev').lower() # "dev" or "prod"
...
if(ENVIRONMENT == 'prod'):
    ...
    },
    {
        ...
        "key": "AIzaSyBNlYH01_9Hc5S1J9vuFmu2nUqBZJNAXxs",
        "channel": 780959847234535464,
        "icon": "https://i.imgur.com/Ay4GImJ.png",
    },
]
else:
    LIVE_SESSION_PING_ROLE = 1131210834744447067
    LIVE_SESSION_CALENDARS = [
        {
            "name": "English 1 - May 23",
            "id": "c_rviuu7v55mu79mq0im1smptg3o%40group.calendar.google.com",
            "key": "AIzaSyBNlYH01_9Hc5S1J9vuFmu2nUqBZJNAXxs",
            "channel": 1104485755637735458,
            "icon": "https://i.imgur.com/vBjyKv7.png",
        },
        {
            "name": "Maths 1 - May 23",
